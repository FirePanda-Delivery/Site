    ...
    <section class="restaurant-offer">
        <div class="container">
            <div class="restaurant-offer-block">
                <div class="restaurant-offer-main">
                    <div class="restaurant-offer-main-overlay">

                        <div class="restaurant-offer-information">
                            <div class="restaurant-offer-title">Макдоналдс</div>
                            <div class="restaurant-offer-descr">
                                <div class="restaurant-offer-rating">
                                    ...
                                    <div class="restaurant-offer-number">4.5</div>
                                </div>
                                <div class="restaurant-offer-order-from">От
                                    <span>300</span>
                                    руб
                                </div>
                                <div class="restaurant-offer-time">06:00 - 22:00</div>
            ...
            <div class="restaurant-content_block" style="display: none;">
        ...
        <div class="container">
            <div class="restaurant-food-block">
                <div class="restaurant-food-wrapper">
                    <ul class="restaurant-food-category">
                        <li>Бургеры</li>
                        <li>Пицца</li>
                        <li>Роллы</li>
                        <li>Салаты</li>
